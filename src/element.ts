import { element, inputElement } from "./interfaces";
...
export class Element {
  ...
  createElement({ tag, id, classNote, content, disable = false }: element) {
  ...
  createCarSVG() {
    ...
    path1.setAttribute(
      'd',
      'M160,307.5h133.538c14.182,0,27.524-7.554,34.82-19.715l14.501-24.169c2.273-3.789,1.045-8.703-2.744-10.976   c-3.788-2.273-8.702-1.045-10.976,2.744l-14.501,24.169c-4.421,7.369-12.507,11.947-21.101,11.947H160c-4.418,0-8,3.582-8,8   S155.582,307.5,160,307.5z'
    );
    path2.setAttribute(
      'd',
